...
#include "SmartAI/MultiplayerSessionsSubsystem.h"
#include "../../Source/Runtime/Engine/Classes/Engine/GameInstance.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMultiplayerSessionsSubsystem() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UGameInstanceSubsystem();
	SMARTAI_API UClass* Z_Construct_UClass_UMultiplayerSessionsSubsystem();
	SMARTAI_API UClass* Z_Construct_UClass_UMultiplayerSessionsSubsystem_NoRegister();
	UPackage* Z_Construct_UPackage__Script_SmartAI();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_UMultiplayerSessionsSubsystem_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_SmartAI,
	};
	...
	template<> SMARTAI_API UClass* StaticClass<UMultiplayerSessionsSubsystem>()
	{
		return UMultiplayerSessionsSubsystem::StaticClass();
	}
	...
	UMultiplayerSessionsSubsystem::~UMultiplayerSessionsSubsystem() {}
	struct Z_CompiledInDeferFile_FID_SmartAI_Source_SmartAI_MultiplayerSessionsSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SmartAI_Source_SmartAI_MultiplayerSessionsSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMultiplayerSessionsSubsystem, UMultiplayerSessionsSubsystem::StaticClass, TEXT("UMultiplayerSessionsSubsystem"), &Z_Registration_Info_UClass_UMultiplayerSessionsSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiplayerSessionsSubsystem), 210871881U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SmartAI_Source_SmartAI_MultiplayerSessionsSubsystem_h_3164108709(TEXT("/Script/SmartAI"),
		Z_CompiledInDeferFile_FID_SmartAI_Source_SmartAI_MultiplayerSessionsSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SmartAI_Source_SmartAI_MultiplayerSessionsSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
